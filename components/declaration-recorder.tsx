    ...
    <div className="flex flex-col justify-between h-screen bg-gradient-to-br from-[#12182A] to-[#242E44] text-white">
      ...
      <div className="flex justify-between items-center p-4 border-b border-white/10 backdrop-blur-sm bg-[#12182A]/80">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-white/70">Assistant • Enregistrement</p>
        </div>

        <div className="flex items-center gap-2">
          <div className="text-right text-xs">
            <div className="font-mono text-amber-300">{timer}</div>
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="relative flex flex-col items-center">
          {/* User Video */}
          <Card className="overflow-hidden h-[400px] w-[600px] bg-gradient-to-b from-[#1c2437] to-[#12182A] border border-white/10 shadow-2xl rounded-3xl mb-8">
            <div className="h-full w-full relative rounded-3xl overflow-hidden">
              ...
              {/* Recording indicator */}
              {isRecording && (
                <div className="absolute top-4 left-4 bg-red-500/90 backdrop-blur-sm rounded-full px-3 py-2 flex items-center">
              ...
              <Button
                ...
                className={`rounded-full h-16 w-16 shadow-lg transition-colors duration-300 ${
                  isRecording
                    ...
                    : "bg-gradient-to-r from-amber-200 to-yellow-500 hover:from-amber-300 hover:to-yellow-600 text-[#12182A]"
                }`}
                size="icon"
